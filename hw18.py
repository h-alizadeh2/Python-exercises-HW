...
class Inventory:
    def init(self, id, name, quantity, price, item_type):
        self.id = id
        self.name = name
...
class Phisycal_item(Inventory):
    def init(self, id, name, quantity, price, weight, dimensions):
        super().init(id, name, quantity, price, item_type="physical")
        self.weight = weight
...
class Digital_item(Inventory):
    def init(self, id, name, quantity, price, file_size, download_link):
        super().init(id, name, quantity, price, item_type="digital")
